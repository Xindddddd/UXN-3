...
# 修复：添加 src/uxn.c 到 uxnemu 编译命令
${CC} ${CFLAGS} src/uxn.c src/devices/system.c src/devices/console.c src/devices/screen.c src/devices/audio.c src/devices/controller.c src/devices/mouse.c src/devices/file.c src/devices/datetime.c src/devices/network.c src/uxnemu.c ${UXNEMU_LDFLAGS} -o bin/uxnemu
